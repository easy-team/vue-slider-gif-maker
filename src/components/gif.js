  ...
  return function e(t, n, r) {
    ...
    1: [ function (require, module, exports) {
      ...
      EventEmitter.prototype.addListener = function (type, listener) {
        ...
        if (!this._events) this._events = {};
        if (this._events.newListener) this.emit("newListener", type, isFunction(listener.listener) ?
          listener.listener : listener);
        if (!this._events[ type ]) this._events[ type ] = listener;
        else if (isObject(this._events[ type ])) this._events[ type ].push(listener);
        else this._events[ type ] = [ this._events[ type ], listener ]; if (isObject(this._events[ type ]) && !this
          ._events[ type ].warned) {
    ...
    3: [ function (require, module, exports) {
      ...
      GIF = function (superClass) {
        ...
        GIF.prototype.addFrame = function (image, options) {
          ...
          } else if (typeof CanvasRenderingContext2D !== "undefined" && CanvasRenderingContext2D !== null &&
            image instanceof CanvasRenderingContext2D || typeof WebGLRenderingContext !== "undefined" &&
        ...
        GIF.prototype.render = function () {
          ...
          this.imageParts = function () {
            var j, ref, results;
            results = [];
            for (i = j = 0, ref = this.frames.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --
              j) {
              results.push(null)
            }
            return results
        ...
        GIF.prototype.spawnWorkers = function () {
          ...
          (function () {
            results = [];
            for (var j = ref = this.freeWorkers.length; ref <= numWorkers ? j < numWorkers : j >
              numWorkers; ref <= numWorkers ? j++ : j--) {
              results.push(j)
            }
            return results
            ...
            return function (i) {
              ...
              worker = new Worker(defaults.workerScript);
        ...
        GIF.prototype.frameFinished = function (frame) {
          ...
          if (this.options.globalPalette === true) {
            ...
            if (this.frames.length > 2) {
              for (i = j = 1, ref = this.freeWorkers.length; 1 <= ref ? j < ref : j > ref; i = 1 <=
                ref ? ++j : --j) {
                this.renderNextFrame()
              }
            }
